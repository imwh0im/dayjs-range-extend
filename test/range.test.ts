...
it('range isEqual', () => {
  ...
  expect(dayjsRange(startDate, endDate).isEqual(dayjsRange(startDate, endDate))).toBe(true)
  expect(dayjsRange(startDate, endDate).isEqual(dayjsRange(endDate, startDate))).toBe(true)
  expect(dayjsRange(endDate, startDate).isEqual(dayjsRange(startDate, otherDate))).toBe(false)
})
...
it('range isOverlap', () => {
  ...
  expect(dayjsRange(startDate, endDate).isOverlap(dayjsRange(startDate, endDate))).toBe(true)
  expect(dayjsRange(endDate, startDate).isOverlap(dayjsRange(startDate, endDate))).toBe(true)
  expect(dayjsRange(startDate, endDate).isOverlap(dayjsRange(endDate, otherDate))).toBe(true)
  expect(dayjsRange(startDate, endDate).isOverlap(dayjsRange(otherDate, otherDate2))).toBe(false)
  expect(dayjsRange(startDate, otherDate).isOverlap(dayjsRange(endDate, otherDate2))).toBe(true)
  expect(dayjsRange(startDate, otherDate2).isOverlap(dayjsRange(endDate, otherDate))).toBe(true)
  expect(dayjsRange(endDate, otherDate).isOverlap(dayjsRange(startDate, otherDate2))).toBe(true)
  expect(dayjsRange(endDate, otherDate).isOverlap()).toBe(false)
  expect(dayjsRange(startDate, endDate).isOverlap(dayjsRange(startDate, null))).toBe(false)
})
